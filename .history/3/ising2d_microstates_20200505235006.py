...
def ising_energy_plot(energies=None, L=2, read_data=False, data_file_name=None, show_plot=True, save_plot=False, plot_file_Name=None):
...
def energy_data_to_frequencies(energies):
