...
# if run_plot_1:
#     figures_fn(pathss_x, read_paths_data, paths_file_name, beta, N_path, N_iter, delta, 
#                potential_string, append_every, N_plot, x_max, N_beta_ticks, msq_file,
#                plot_file_name, show_theory, show_matrix_squaring, show_path, show_compare_hist,
#                show_complete_path_hist, save_plot, show_plot)
...
# Parámetros técnicos de figuras
kwargs_update = {'show_theory': False,
                 'show_matrix_squaring': True,
                 'show_path': True,
                 'show_compare_hist': False,
                 'show_complete_path_hist': False,
