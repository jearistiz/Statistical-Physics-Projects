    ...
    if plot_energy:
        ...
        if save_plot_E:
            if E_plot_name is None:
                ...
                E_plot_name='E-ms-%s-beta_max_%.3f-beta_min_%.3f-'%(potential_string,1./temp_min,1./temp_max) + \
                            'N_temp_%d-x_max_%.3f-nx_%d-'%(N_temp,x_max,nx) + \
...
if calculate_avg_energy:
    average_energy( read_Z_data, generate_Z_data, Z_file_name, plot_energy, save_plot_E,
                    ...
                    pi_x_file_name, relevant_info_pi_x, plot, save_plot, show_plot   )
