...
for i, potential in enumerate([ 
                               [anharmonic_potential, 'anharmonic_potential', 'pi_x-ms-anharmonic_potential-beta_fin_4.000-x_max_5.000-nx_201-N_iter_9.csv'],
                               [harmonic_potential, 'harmonic_potential', 'pi_x-ms-harmonic_potential-beta_fin_4.000-x_max_5.000-nx_201-N_iter_9.csv']
                               ]):
    ...
    kwargs = {
        ...
        'N_iter': int(1e6),
        'delta': 0.5,
        'potential': potential[0],  # harmonic_potential,
        'potential_string': potential[1],  # 'harmonic_potential',
        'append_every': 1,
    ...
    kwargs_update = {
        ...
        'msq_file': potential[2], #'pi_x-ms-harmonic_potential-beta_fin_4.000' #+ '-x_max_5.000-nx_201-N_iter_7.csv',
        'plot_file_name': None,
        'show_QHO_theory': False,
