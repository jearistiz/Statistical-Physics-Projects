...
read_opt_data = False
save_opt_data = True
opt_data_file_name = 'opt-test-1' #script_dir + '/pi_x-ms-opt-harmonic_potential-beta_fin_4.000-x_max_5.000-nx_min_10-nx_max_1001-nx_sampling_50-N_iter_min_1-N_iter_max_20.csv'
plot_opt = True
show_opt_plot = True
save_plot_opt = True
