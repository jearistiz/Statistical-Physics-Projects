...
Z_file_name = 'Z-test1.csv'  #None
plot_energy = True
save_plot_E = True
show_plot_E = True
E_plot_name = 'E-test1.png'  #None #script_dir + 'E.eps'

# Parámetros físicos para calcular Z y <E>
temp_min = 1./10
temp_max = 1./2
N_temp = 10
potential, potential_string = anharmonic_potential, 'harmonic_potential'

# Más parámetros técnicos
save_Z_csv = True
relevant_info_Z = ['Z test1']#None
print_Z_data = False
x_max = 7.
nx = 201
N_iter = 7
