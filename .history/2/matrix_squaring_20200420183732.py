...
def average_energy( generate_Z_data=False, read_Z_data=True, Z_file_name = 'Z.csv',
    ...
    if read_Z_data:
        ...
        print(  'Elegir si se generan o se leen los datos para la función partición.\n'+
                'Estas opciones son mutuamente exluyentes')
    # READ DATA IS OK
