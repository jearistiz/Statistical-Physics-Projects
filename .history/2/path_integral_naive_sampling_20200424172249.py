    ...
    if save_plot:
        if plot_file_name is None:
            ...
            plot_file_name = ('pi_x-pi-plot-%s-beta_%.3f-'%(potential_string, beta)
                              ...
                              + 'append_every_%d-x_max_%.3f-theory_%d-ms_%d-path_%d-compare_%d-complete_path-%d.eps'
                    %(append_every,x_max,show_theory,show_matrix_squaring,show_path,show_compare_hist,show_complete_path_hist))
