...
def figures_fn(pathss_x, beta = 4 , N_plot = 201, x_max = 3, n_steps=int(1e5), append_every=1, script_dir=os.path.dirname(os.path.abspath(__file__)), msq_file='file.csv', file_name='path-plot-prueba', 
