...
def figures_fn(pathss_x=None, read_paths_data=False, paths_file_name=None, beta=4.,
               N_iter=int(1e5), delta=0.5, potential_string='harmonic_potential',
               N_plot=201, x_max=3, append_every=1, N_beta_ticks=11, msq_file='file.csv',
