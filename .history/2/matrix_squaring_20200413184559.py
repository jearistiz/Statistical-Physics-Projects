...
def density_matrix_convolution(rho, grid_x, dx, potential=harmonic_potential, N_beta = 4, beta_fin = 4, print_steps=True):
    """
    Uso:    entrega (N_beta-1) convoluciones de la matriz densidad rho(beta_fin/N_beta) = rho(beta_fin)
    """
    N_conv = N_beta-1
