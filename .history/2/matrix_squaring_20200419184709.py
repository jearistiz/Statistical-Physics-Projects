...
for beta_fin in [5,4,3,2,1,0.5,0.25]:
    rho, trace_rho, grid_x = run_pi_x_sq_trotter( beta_fin = beta_fin, potential = harmonic_potential,
                                                potential_string =  'harmonic_potential',
                                                save_data=False, save_plot=False, show_plot=True)
