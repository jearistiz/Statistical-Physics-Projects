...
def path_naive_sampling(N = 10,beta = 4., n_steps = int(1e5), delta = 0.5, potential = harmonic_potential, append_every = 1):
    """
    Uso: 
    """
    dtau = beta/N
...
def figures_fn(pathss_x, beta = 4 , N_plot = 201, x_max = 3, n_steps=int(1e5), append_every=1, msq_file='file.csv', file_name='path-plot-prueba', show_path=True, show_matrix_squaring=True, save_plot=True, show_plot=True):
...
figures_fn(pathss_x, beta = beta, N_plot = 201, x_max = 3, msq_file='file.csv')