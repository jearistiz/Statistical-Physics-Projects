...
def save_csv(data, data_headers=None, file_name='file.csv', relevant_info=None, print_data=True):
    ...
    Recibe:
        data: list of lists, shape=(nx,ny)  ->  cada lista es una columna del archivo.
    ...
    elif len(data_headers)!=len(data):
...
#save_paths_x_csv(pathss_x, csv_file_name, relevant_info)
save_csv(pathss_x.transpose(), None, 'test_1.csv', relevant_info)
#
#
#################################################################################################
