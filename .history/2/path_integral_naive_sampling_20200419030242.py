...
plot_file_name =    'pi_x-pi-plot-%s-N_path_%d-N_iter_%d-beta_fin_%.3f-delta_%.3f-append_every_%d-x_max_%.3f-theory_%d-ms_%d-path_%d-compare_%d-complete_path-%d.png'\
