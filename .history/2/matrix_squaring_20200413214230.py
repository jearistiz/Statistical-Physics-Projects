...
def run_matrix_squaring(x_max = 5., nx = 200, N_iter = 7, beta_fin = 4, potential = harmonic_potential, potential_string =  'harmonic_potential', print_steps=True):
    ...
    print('\n----------------------------------------------------',
            u'beta = %.3f      Z(beta) = Tr(rho(beta)) ≈ %.3E'%(beta_fin_2,trace_rho))
