...
def optimization(generate_opt_data=True, read_opt_data=False, beta_fin=4, x_max=5, 
    ...
    if generate_opt_data:
        ...
        # Calcula error para cada valor de nx y N_iter especificado (equivalentemente dx y beta_ini)
    ...
    # Calcula las rejillas de valores para dx y bete_ini, para graficar contour plot
