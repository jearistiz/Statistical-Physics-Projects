...
rho_data = [grid_x,weights]
rho_data = pd.DataFrame(data=rho_data , columns=['Prob. density','Position x'])
rho_csv = open('rho-%s-x_max_%.3f-nx_%d-N_beta_%d-beta_fin_%.3f.csv'%(x_max,nx,N_beta,beta_fin),'a')
rho_csv.write('# ')
