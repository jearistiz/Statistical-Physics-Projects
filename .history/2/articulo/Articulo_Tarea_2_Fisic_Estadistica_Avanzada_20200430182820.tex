...
\end{equation}
es decir, es un número aleatoro distribuído uniformemente entre $-\delta$ y $\delta$. El nuevo camino propuesto $X_\mathrm{new}=[x_1,\,\,x_2,\,\,\dots,\,\,x_{i\_\mathrm{new}},\,\,\dots,\,\,x_{N-1}]$ tiene asociada una amplitud de probabilidad 
\begin{align}
	p(&X_\mathrm{new}) = \nonumber \\
...
Para este algoritmo, el camino que se cambiará en cada iteración consta de diez posiciones. Es decir, en (\ref{eq:path-ini}) se toma $N=10$. Además se tomó $\delta = 0.5$
