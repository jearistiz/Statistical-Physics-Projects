...
\begin{align}
	...
	& \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, \cdots \rho (x_{N-1},x^{\prime}; \beta/N)
\end{align}
cuando $N\rightarrow\infty$ se obtiene la integral de camino que usualmente se denota
\begin{equation}
	\rho\left(x, x^{\prime} ; \beta \right) = \int \mathcal{ D } x(\beta) \Phi[x(\beta)],
\end{equation}
donde
\begin{equation}
	\Phi[x(\beta)]=\lim _{\varepsilon \rightarrow 0 \atop n \varepsilon=\beta} \rho\left(x, x_{1} ; \beta\right) \rho\left(x_{1}, x_{2} ; \beta\right) \cdots \rho\left(x_{N-1}, x^{\prime} ; \beta\right)
\end{equation}
