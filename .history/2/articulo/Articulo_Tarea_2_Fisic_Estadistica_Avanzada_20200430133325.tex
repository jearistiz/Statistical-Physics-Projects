...
En cada iteración se debe guardar el camino aceptado. Posteriormente, construyendo el histograma de los valores de posiciones $x_i$ o de los valores de posiciones de todos los caminos unidos $x_0 \mathrm{U} x_1 \mathrm{U} \cdots \mathrm{U} x_{N-1}$  obtendremos una aproximación a la probabilidad (\ref{eq:pi-x})
