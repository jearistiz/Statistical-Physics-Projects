...
La figura \ref{fig:Msq-anharm} muestra los valores $\pi^{(Q)}_\mathrm{teo}(x ; \beta_\mathrm{fin})$ y $\pi^{(Q)}_\mathrm{comp}(x ; \beta_\mathrm{fin})$ para el potencial anarmónico
\begin{equation}
...
\begin{figure}[!ht]
	...
	\caption{\hl{caption cambiar este gráfico por uno que muestre también el oscilador amharmónico}}
