...
\begin{figure}[!ht]
	...
	\caption{Error relativo cuantificado por (\ref{eq:Msq-err-comp}) para $\bet_\mathrm{fin}=4$. Notamos que cuanto más pequeño sea $\beta_\mathrm{ini}$, la discretización $\dx$ debe disminuir también para evitar que el error computacional sea grande.}
