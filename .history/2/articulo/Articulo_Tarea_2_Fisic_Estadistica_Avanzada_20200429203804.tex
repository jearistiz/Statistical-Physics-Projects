...
\begin{equation}
	\hat{\rho} = \mathrm{e}^{-\beta \hat{H}}.
\end{equation}
De este modo es muy sencillo ver que
\begin{equation}
	\hat{\rho} = \mathrm{e}^{-\beta\hat{H}/N} \cdot \mathrm{e}^{-\beta\hat{H}/N}  \cdots \mathrm{e}^{-\beta\hat{H}/N} \rightarrow \text{$N$ veces en total}. \label{eq:convolution}
\end{equation}
...
\begin{equation}
\hat{\rho} = \mathrm{e}^{-\beta\hat{H}/2} \cdot \mathrm{e}^{-\beta\hat{H}/2}
\end{equation}
