...
%A continuación se muestra el código que corre los algoritmos que se usaron para la parte de Matrix Squaring en la sección \ref{subsec:MtxSq-results}. Éste código usa el módulo matrix_squaring que está diaponible en \href{https://github.com/jearistiz/Statistical-Physics-Projects/blob/master/2/matrix_squaring.py}{este link}. Cada función del módulo está comentada y explicada. 
...
%A continuación se muestra el código que corre los algoritmos que se usaron para la parte de Matrix Squaring en la sección \ref{subsec:PathInt-results}. Éste código usa el módulo matrix_squaring que está diaponible en \href{https://github.com/jearistiz/Statistical-Physics-Projects/blob/master/2/path_integral_naive_sampling.py}{este link}. Cada función del módulo está comentada y explicada. 
