...
\begin{align}
	\rho (x,&x^{\prime};2^{-N_{\mathrm{iter}}+1}\beta_{\mathrm{fin}}) = \nonumber \\
	&\int dx_1 \mathrm{e}^{-\frac{1}{2} \beta V(x)} \rho^{\mathrm{free}}\left(x, x_1, \beta\right) \mathrm{e}^{-\frac{1}{2} \beta V\left(x_1\right)}   \mathrm{e}^{-\frac{1}{2} \beta V(x_1)} \nonumber \\
	&\;\;\;\;\; \;\;\;\;\; \;\;\;\;\; \times \rho^{\mathrm{free}}\left(x_1, x^{\prime}, \beta\right) \mathrm{e}^{-\frac{1}{2} \beta V\left(x^{\prime}\right)}.
\end{align}
