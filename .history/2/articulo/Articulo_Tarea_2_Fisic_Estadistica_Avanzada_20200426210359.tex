...
\begin{figure}[h]
	\centering
	\includegraphics[width=\fullwidth]{{{figures/pi_x-ms-opt-plot-harmonic_potential-beta_fin_4.000-x_max_5.000-nx_min_20-nx_max_1121-nx_sampling_50-N_iter_min_9-N_iter_max_20}}}
	\caption{\hl{caption}}
\end{figure}
