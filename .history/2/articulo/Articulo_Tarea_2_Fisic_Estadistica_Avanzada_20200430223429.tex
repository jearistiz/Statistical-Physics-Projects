...
\begin{description}
\item[Palabras clave] 	Oscilador armónico, potencial anarmónico, física estadística cuántica, baño térmico, ensamble \\
						canónico, \textit{matrix squaring}, \textit{path integral}.
\end{description}
\end{abstract}
