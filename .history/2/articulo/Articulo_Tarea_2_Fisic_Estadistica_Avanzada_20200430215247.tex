...
A continuación se muestra el código que corre los algoritmos que se usaron para la parte de Matrix Squaring en la sección \ref{subsec:Mtxsq-results}. Éste código usa el módulo matrix_squaring que está diaponible en . Cada función del módulo está comentada y explicada. 
