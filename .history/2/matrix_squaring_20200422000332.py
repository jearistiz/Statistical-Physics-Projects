...
plot_opt = True
save_plot_opt = True
opt_plot_file_name = script_dir + '/pi_x-ms-opt-plot-harmonic_potential-beta_fin_4.000-x_max_5.000-nx_min_10-nx_max_1001-nx_sampling_50-N_iter_min_1-N_iter_max_20.png'  #None
if run_optimization:
    t_0 = time()
    error, dx_grid, beta_ini_grid = \
        optimization(   generate_opt_data, read_opt_data, beta_fin, x_max, potential, 
                        ...
                        save_plot_opt, opt_plot_file_name   )
    t_1 = time()
    print(  '-----------------------------------------' +
            '-----------------------------------------\n' +
