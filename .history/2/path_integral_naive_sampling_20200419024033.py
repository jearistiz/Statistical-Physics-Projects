...
plot_file_name =    'pi_x-pi-plot-%s-N_path_%d-N_iter_%d-beta_fin_%.3f-x_max_%.3f-theory_%d-ms_%d-path_%d-compare_%d-complete_path-%d'\
                    %(potential_string,N_path,N_iter,beta,x_max,show_theory,show_matrix_squaring,show_path,show_compare_hist,show_complete_path_hist)
