...
def figures_fn(pathss_x, beta = 4 , N_plot = 201, x_max = 3, n_steps=int(1e5), append_every=1, msq_file='file.csv', file_name='/path-plot-prueba.eps', show_path=True, save_plot=True, show_plot=True):
