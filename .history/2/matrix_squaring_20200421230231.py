...
def save_csv(data, data_headers=None, data_index=None, file_name=None, relevant_info=None, print_data=True):
    """
...
def optimization(   beta_fin=4, x_max=5, potential=harmonic_potential, 
                    ...
                    save_opt_data = False, opt_data_file_name = None, 
    ...
    if save_opt_data:
        ...
        relevant_info=['Optimization of parameters dx and beta_ini of matrix squaring algorithm',
...
save_plot_opt = True
t_0 = time()
error, dx_grid, beta_ini_grid = optimization(beta_fin,x_max,potential,potential_string,nx_min,nx_max,nx_sampling,N_iter_min,N_iter_max,save_opt_data,opt_data_file_name,plot_opt,save_plot_opt)
t_1 = time()
print(  '----------------------------------------------------------------------------------\n' +
