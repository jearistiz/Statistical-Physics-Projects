...
def Z_several_values(   temp_min=1./10, temp_max=1/2., N_temp=10, save_Z_csv=True,
                        ...
                        x_max=5., nx=201, N_iter=7, potential = harmonic_potential,
                        potential_string = 'harmonic_potential', print_steps=True,
                        save_data=False, plot=False, save_plot=False, show_plot=False   ):
    """
    """
    ...
    for beta_fin in beta_array:
        ...
        run_pi_x_sq_trotter(x_max=x_max, nx=nx, beta_fin=beta_fin, potential=potential,
                                potential_string=potential_string,print_steps=print_steps,
                                save_data=save_data, plot=plot, save_plot=save_plot, 
                                show_plot=show_plot)
        Z.append(trace_rho)
    ...
    if save_Z_csv == True:
        Z_data = save_csv(Z_data,Z_data_headers,relevant_info=relevant_info, file_name=Z_file_name,print_data=False)
