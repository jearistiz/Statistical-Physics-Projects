...
run_pi_x_sq_trotter(x_max=5., nx=201, N_iter=7, beta_fin=4, potential=harmonic_potential,
...
optimization(generate_opt_data=True, read_opt_data=False, beta_fin=4, x_max=5, 
...
if run_ms_algorithm:
    ...
    # Parámetros técnicos (generar figuras, etc.)
    print_steps = False
    save_data = False
    file_name = None
    relevant_info = None
    ...
    rho, trace_rho, grid_x = run_pi_x_sq_trotter(x_max, nx, N_iter, beta_fin, potential,
                                                 ...
                                                 save_plot, show_plot, plot_file_name)
