...
run_pi_x_squaring(x_max=15., nx=201, N_iter=7, beta_fin=5, potential=anharmonic_potential,
                         potential_string =  'anharmonic_potential', print_steps=True,
                         save_data=True, plot=True, save_plot=False, show_plot=True)
