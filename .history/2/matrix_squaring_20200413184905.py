...
def density_matrix_convolution_trotter(rho, grid_x, dx, N_beta = 4, beta_fin = 4, print_steps=True):
    """
    Uso:    entrega (N_beta-1) convoluciones de la matriz densidad rho(beta_fin/N_beta) que se obtiene con 
            aproximación de trotter, es decir, entrega aproximación de rho(beta_fin). 
    """
    N_conv = N_beta-1
