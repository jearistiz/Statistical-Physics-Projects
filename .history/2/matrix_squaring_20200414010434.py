...
def density_matrix_squaring(rho, grid_x, N_iter = 1, beta_ini = 1, print_steps=True):
    ...
    Uso:    devuelve matriz densidad luego de aplicarle algoritmo matrix squaring N_iter veces.
            en la primera iteración se usa matriz de densidad dada por rho; en las siguientes 
            iteraciones se usa matriz densidad generada por la iteración inmediatamente anterior.
