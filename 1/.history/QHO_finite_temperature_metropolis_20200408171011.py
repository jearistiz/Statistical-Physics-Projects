...
def run_metropolis():
    ...
    Devuelve:   x_hist: list        ->  Lista con valores de x (posiciones)  obtenida mediante la cadena de Markov. 
                n_hist: list        ->  Lista con valores de n (niveles de energía) obtenidos mediante cadena de Markov.
                psi_final: dict     ->  Diccionario con autoestados de energía \psi_{n}(x) = psi[x][n] 
