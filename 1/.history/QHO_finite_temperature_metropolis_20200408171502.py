...
def run_metropolis(x_limit=5., N_points_x = 51):
    ...
    Devuelve:   
        x_hist: list        ->  Lista con valores de x (posiciones)  obtenida mediante la cadena de Markov. 
    ...
    Recibe:
        x_limit, N_points_x: float      -> las autofunciones se inicializan en intervalo (-x_limit,x_limit) 
