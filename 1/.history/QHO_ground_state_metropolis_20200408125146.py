...
def metropolis(N=int(1e6),x0=0.0,delta=0.5,prob_amplitude_sampling=QHO_ground):
    """
    Uso: devuelve lista con N valores de x muestreados de la densidad de probabilidad
...
def run_metropolis(N=1e5, x0=0.0, delta=0.5, prob_amplitude_sampling=False, 
    ...
    """
    t_0 = time()
    x_hist = metropolis(N,x0,delta,prob_amplitude_sampling=QHO_ground)
    t_1 = time()
