...
def run_metropolis(psi_0_1 = psi_0_1, x_limit=5., N_points_x = 51,
                    ...
                    showplot = True, savefifig=[False,'plot_QHO_finite_temp_beta_unknown.eps'], legend_loc='best', x_plot = 6):
    """
    ...
    Recibe:
        ...
        x_plot: float                       -> dominio de la gráfica en x será (-x_plot,x_plot)
    ...
    x_plot = np.linspace(-x_plot,x_plot,200)
