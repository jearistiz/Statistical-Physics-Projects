...
showplot = True
savefig = [False,'plot_QHO_ground_state.eps']
xlim = 5*2**(-0.5)
x_plot = np.linspace(-xlim,xlim,200)

run_metropolis(N=N, x0=x0, delta=delta, prob_amplitude_sampling=prob_amplitude_sampling, 
                    showplot=True, savefig=savefig,
