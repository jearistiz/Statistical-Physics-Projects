...
El caso de mayor temperatura en las gráficas que mostramos está en la figura \ref{fig:beta_0.2}. Este es un caso de alta temperatura, lo cual podemos comprobar notando que 
