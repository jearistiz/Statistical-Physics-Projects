...
\title{Oscilador armónico cuántico unidimensional en baño térmico usando el algoritmo Metrópolis.}% Force line breaks with \\
...
\begin{abstract}
En este artículo presentamos un estudio del oscilador armónico cuántico unidimensional en un baño térmico. En particular, nos interesamos por calcular la probabilidad de encontrar el sistema en una posición dada. Para esto, presentamos los cálculos teóricos cuánticos y su contraparte clásica, con el fin de comparar los resultados. Especialmente nos enfocamos en usar el algoritmo Metrópolis para reconstruir histogramas que representan las densidades de probabilidad cuánticas deseadas, tanto en el espacio de posiciones como en los niveles de energía. Estos resultados cuánticos los usamos para contrastarlos con los clásicos. Los tres casos presentados corresponden a baja, media y alta temperatura, y los resultados concuerdan claramente con los cálculos teóricos.
\begin{description}
